...
const studentConverter = {
    toFirestore: function (student) {
        return {
            ...
            last_visited: (student.last_visited == undefined ? null : student.last_visited),
            attendance_streak: (student.attendance_streak == undefined ? null : student.attendance_streak),
            challenge_questions: student.challenge_questions,
            module_bonus: student.module_bonus
        }
    },
